...
redis:set(Devil.."getidstatus"..msg.chat_id_, "Simple")
...
redis:set(Devil.."getidstatus"..msg.chat_id_, "Photo")
...
redis:set(Devil..'lock:kara:'..msg.chat_id_,'on')
return "← أهلًا عزيزي "..msg.TheRankCmd.."تم تعطيل الرفع في المجموعه \n"
end
function cmds_off(msg)
if not msg.Creator then return "← هذا الامر يخص :\n  المنشئ , المطور فقط  \n"
end
redis:set(Devil..'lock:kara:'..msg.chat_id_,'off')
...
redis:set(Devil..'lock:join:'..msg.chat_id_,true)
...
redis:del(Devil..'lock:join:'..msg.chat_id_)
return "← أهلًا عزيزي "..msg.TheRankCmd.." تم فتح الدخول بالرابط \n" 
end


local function iDevil(msg,MsgText)

Channel = redis:get(Devil..'setch') or katrenno
--JoinChannel
function is_JoinChannel(msg)
if redis:get(Devil..'joinchnl') then
...
redis:setex(Devil..'ExpireDate:'..msg.chat_id_, extime, true)
if not redis:get(Devil..'CheckExpire::'..msg.chat_id_) then 
redis:set(Devil..'CheckExpire::'..msg.chat_id_,true) end
sendMsg(msg.chat_id_,msg.id_,'💂🏻‍♀️│تم شحن الاشتراك الى `'..MsgText[2]..'` يوم   ... 👍🏿')
sendMsg(SUDO_ID,0,'💂🏻‍♀️│تم شحن الاشتراك الى `'..MsgText[2]..'` يوم   ... 👍🏿\n🕵🏼️‍♀️│في مجموعه  » »  '..redis:get(Devil..'group:name'..msg.chat_id_))
else
...
if not msg.SudoUser then return "هذا الامر يخص المطور, فقط  \n" end
if MsgText[2] == '1' then
redis:setex(Devil..'ExpireDate:'..msg.chat_id_, 2592000, true)
if not redis:get(Devil..'CheckExpire::'..msg.chat_id_) then 
redis:set(Devil..'CheckExpire::'..msg.chat_id_,true) 
end
sendMsg(msg.chat_id_,msg.id_,'💂🏻‍♀️│تم تفعيل الاشتراك   👍🏿\n📆│ الاشتراك » `30 يوم`  *(شهر)*')
sendMsg(SUDO_ID,0,'💂🏻‍♀️│تم تفعيل الاشتراك  👍🏿\n📆│ الاشتراك » `30 يوم`  *(شهر)*')
end
if MsgText[2] == '2' then
redis:setex(Devil..'ExpireDate:'..msg.chat_id_,7776000,true)
if not redis:get(Devil..'CheckExpire::'..msg.chat_id_) then 
redis:set(Devil..'CheckExpire::'..msg.chat_id_,true) 
end
...
if MsgText[2] == '3' then
redis:set(Devil..'ExpireDate:'..msg.chat_id_,true)
if not redis:get(Devil..'CheckExpire::'..msg.chat_id_) then 
redis:set(Devil..'CheckExpire::'..msg.chat_id_,true) end
...
if not msg.Admin then return "← هذا الامر يخص :\n الادمن ,المدير ,المنشئ ,المطور فقط \n" end
local check_time = redis:ttl(Devil..'ExpireDate:'..msg.chat_id_)
...
local GroupName = (redis:get(Devil..'group:name'..msg.chat_id_) or '')
redis:set(Devil..'linkGroup'..msg.chat_id_,(data.invite_link_ or ""))
...
users = redis:get(Devil..'user_names:'..v.user_id_) or v.user_id_
x = x + 1
...
if not msg.Director then return "← هذا الامر يخص :\n المدير ,المنشئ ,المطور فقط  \n " end
local Chek_Info = https.request('https://api.telegram.org/bot'..Token..'/getChatMember?chat_id='.. msg.chat_id_ ..'&user_id='.. Devil..'')
...
if not msg.Director and redis:get(Devil..'lock_pin'..msg.chat_id_) then
...
function(arg,data)
if data.ID == "Ok" then
redis:set(Devil..":MsgIDPin:"..msg.chat_id_,msg.reply_id)
return sendMsg(msg.chat_id_,msg.id_," ⋆  ⇽ أهلًا  "..msg.TheRankCmd.." تم تثبيت الرساله \n ⋆ ")
elseif data.ID == "Error" and data.code_ == 6 then
return sendMsg(msg.chat_id_,msg.id_,'  عذرًا لا يمكنني التثبيت .   لا املك صلاحيه التثبيت \n ')    
end
end,nil)
end
return false
...
function(arg,data) 
if data.ID == "Ok" then
return sendMsg(msg.chat_id_,msg.id_," ← أهلا  "..msg.TheRankCmd.."  تم الغاء تثبيت الرساله  .")    
elseif data.ID == "Error" and data.code_ == 6 then
return sendMsg(msg.chat_id_,msg.id_,' ⋆  ⇽ عذرا لا يمكنني الغاء التثبيت \n  لست مشرف او لا املك صلاحيه التثبيت . ')    
elseif data.ID == "Error" and data.code_ == 400 then
return sendMsg(msg.chat_id_,msg.id_,' ⋆  ⇽ عذرا  '..msg.TheRankCmd..'   لا توجد رساله مثبته لاقوم بازالتها . ')    
end
end,nil)
end
return false
...
if not msg.Creator then return "← هذا الامر يخص :\n الادمن ,المدير ,المنشئ ,المطور فقط \n  " end
if not MsgText[2] and msg.reply_id then
if redis:get(Devil..'lock:kara:'..msg.chat_id_) == 'off' then
...
if redis:get(Devil..'lock:kara:'..msg.chat_id_) == 'on' then
...
local Admins = redis:scard(Devil..'admins:'..msg.chat_id_)
redis:del(Devil..'admins:'..msg.chat_id_)
local NumMDER = redis:scard(Devil..'owners:'..msg.chat_id_)
redis:del(Devil..'owners:'..msg.chat_id_)
local MMEZEN = redis:scard(Devil..'whitelist:'..msg.chat_id_)
redis:del(Devil..'whitelist:'..msg.chat_id_)
...
if not msg.Director then return "← هذا الامر يخص :\n المدير ,المنشئ ,المطور فقط  \n " end
if not redis:get(Devil..'ExCmdLink'..msg.chat_id_) then
local LinkGp = ExportLink(msg.chat_id_)
if LinkGp then
LinkGp = LinkGp.result
redis:set(Devil..'linkGroup'..msg.chat_id_,LinkGp)
redis:setex(Devil..'ExCmdLink'..msg.chat_id_,120,true)
...
if not msg.Director then return "← هذا الامر يخص :\n المدير ,المنشئ ,المطور فقط  \n " end
redis:setex(Devil..'linkGroup'..msg.sender_user_id_,300,true)
return '← عزيزي قم برسال الرابط الجديد . '
end

if MsgText[1] == "الرابط" then
if not redis:get(Devil..'linkGroup'..msg.chat_id_) then 
return "← لا يوجد رابط اكتب لانشاء الرابط ." 
end
local GroupName = redis:get(Devil..'group:name'..msg.chat_id_)
local GroupLink = redis:get(Devil..'linkGroup'..msg.chat_id_)
...
local Text = " ← رابـط الـمـجـمـوعه :\n "..Flter_Markdown(redis:get(Devil..'group:name'..msg.chat_id_)).." :\n\n["..GroupLink.."]\n"
...
redis:set(Devil..'flood'..msg.chat_id_,MsgText[2]) 
...
if not msg.Director then return "← هذا الامر يخص :\n المدير ,المنشئ ,المطور فقط  \n" end
local Mn3Word = redis:scard(Devil..':Filter_Word:'..msg.chat_id_)
if Mn3Word == 0 then 
return " ← عذرًا لا توجد كلمات ممنوعه ليتم مسحها . " 
end
redis:del(Devil..':Filter_Word:'..msg.chat_id_)
...
redis:del(Devil..'rulse:msg'..msg.chat_id_)
...
if not msg.Director then return "← هذا الامر يخص :\n المدير ,المنشئ ,المطور فقط  \n " end
if not redis:get(Devil..'welcome:msg'..msg.chat_id_) then 
return " ⋆  ⇽ لايوجد ترحيب ليتم مسحه ." 
end
redis:del(Devil..'welcome:msg'..msg.chat_id_)
return " أهلًا عزيزي "..msg.TheRankCmd.."   \n تم تم حذف الترحيب بنجاح "
end


if MsgText[2] == "المنشى الاساسي" then
if not msg.SudoUser then return "هذا الامر يخص المطور فقط  \n" end
local NumMnsha = redis:scard(Devil..':Hussain:'..msg.chat_id_)
if NumMnsha ==0 then 
return " عذرا لا يوجد منشئ اساسي \n!" 
end
redis:del(Devil..':Hussain:'..msg.chat_id_)
...
if not msg.SudoUser then return "هذا الامر يخص المطور فقط  \n" end
local NumMnsha = redis:scard(Devil..':MONSHA_BOT:'..msg.chat_id_)
if NumMnsha ==0 then 
return " عذرا لا يوجد منشئيين ليتم مسحهم \n!" 
end
redis:del(devil..':MONSHA_BOT:'..msg.chat_id_)
...
local list = redis:smembers(Devil..'banned:'..msg.chat_id_)
if #list == 0 then return " لا يوجد مستخدمين محظورين   " end
message = '  قائمه الاعضاء المحظورين :\n'
for k,v in pairs(list) do
StatusLeft(msg.chat_id_,v)
end 
redis:del(Devil..'banned:'..msg.chat_id_)
return " ⋆  ⇽ أهلًا عزيزي "..msg.TheRankCmd.."   \n  تم مسح {* "..#list.." *} من المحظورين  "
end

if MsgText[2] == 'المكتومين' then
if not msg.Director then return "← هذا الامر يخص :\n المدير ,المنشئ ,المطور فقط  \n " end
local MKTOMEN = redis:scard(Devil..'is_silent_users:'..msg.chat_id_)
if MKTOMEN ==0 then 
return "← لا يوجد مستخدمين مكتومين في المجموعه . " 
end
redis:del(Devil..'is_silent_users:'..msg.chat_id_)
...
redis:del(Devil..'linkGroup'..msg.chat_id_)
...
if not msg.Creator then return "←هذا الامر يخص :\n الادمن ,المدير ,المنشئ ,المطور فقط \n  " end
redis:setex(Devil..'name:witting'..msg.sender_user_id_,300,true)
...
return sendMsg(msg.chat_id_,msg.id_,'⋆  ⇽ تم مسح صورة المجموعه .')
end
...
redis:setex(Devil..'photo:group'..msg.chat_id_..msg.sender_user_id_,300,true)
...
if not msg.Creator then return "← هذا الامر يخص :\n الادمن ,المدير ,المنشئ ,المطور فقط \n  " end
redis:setex(Devil..'about:witting'..msg.sender_user_id_,300,true) 
...
kick_user(v.user_id_,msg.chat_id_,function(arg,data)  
redis:srem(Devil..':MONSHA_BOT:'..msg.chat_id_,v.user_id_)
redis:srem(Devil..'whitelist:'..msg.chat_id_,v.user_id_)
redis:srem(Devil..'owners:'..msg.chat_id_,v.user_id_)
redis:srem(Devil..'admins:'..msg.chat_id_,v.user_id_)
end)
end
NumMem = NumMem + 1
...
if MsgText[1] == "ايدي" or MsgText[1]:lower() == "id" then
  ...
  if redis:get(Devil..'lock_id'..msg.chat_id_) then
  local msgs = redis:get(Devil..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 1
  GetUserID(msg.sender_user_id_,function(arg,data)
  if data.username_ then UserNameID = " • 𝑈𝑆𝐸 𖣫 @"..data.username_.." \n" else UserNameID = "" end
  local zz = (redis:get(Devil..':User_Points:'..msg.chat_id_..msg.sender_user_id_) or 0)
  local rfih = (redis:get(Devil..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
...
GetUserID(msg.sender_user_id_,function(arg,data)
local msgs = (redis:get(Devil..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 0)
local NumGha = (redis:get(Devil..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local photo = (redis:get(Devil..':photo:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local sticker = (redis:get(Devil..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local voice = (redis:get(Devil..':voice:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local audio = (redis:get(Devil..':audio:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local animation = (redis:get(Devil..':animation:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local edited = (redis:get(Devil..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local video = (redis:get(Devil..':video:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
...
redis:del(Devil..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_)
return "تم مسح {* "..msgs.." *} من رسائلك "
end

if MsgText[1]== 'جهاتي' then
return '⋆  ⇽  عدد جهاتك المضافہ‏‏ ⇜ 〈 '..(redis:get(Devil..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)..' 〉 '
end

if MsgText[1] == 'مسح' and MsgText[2] == 'جهاتي'  then
local adduser = redis:get(Devil..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0
if adduser == 0 then  return " ⋆  ⇽  عذرًا ليس لديك جهات لكي يتم مسحها ." end
redis:del(Devil..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) 
...
local points = redis:get(dreem..':User_Points:'..msg.chat_id_..msg.sender_user_id_) or 0
if points == 0 then  return " ⋆  ⇽ عذرًا ليس لديك نقاط لكي يتم مسحها" end
redis:del(dreem..':User_Points:'..msg.chat_id_..msg.sender_user_id_)
return " ⋆  ⇽ تم مسح {* "..points.." *} من نقاطك . "
end

if MsgText[1] == 'معلوماتي' or MsgText[1] == 'موقعي' then
GetUserID(msg.sender_user_id_,function(arg,data)
local msgs = (redis:get(dreem..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 0)
local NumGha = (redis:get(dreem..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local photo = (redis:get(dreem..':photo:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local sticker = (redis:get(dreem..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local voice = (redis:get(dreem..':voice:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local audio = (redis:get(dreem..':audio:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local animation = (redis:get(dreem..':animation:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local edited = (redis:get(dreem..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local video = (redis:get(dreem..':video:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
...
GetUserID(msg.sender_user_id_,function(arg,data)
local msgs = (redis:del(dreem..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 0)
local NumGha = (redis:del(dreem..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local photo = (redis:del(dreem..':photo:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local sticker = (redis:del(dreem..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local voice = (redis:del(dreem..':voice:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local audio = (redis:del(dreem..':audio:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local animation = (redis:del(dreem..':animation:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local edited = (redis:del(dreem..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local video = (redis:del(dreem..':video:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
...
if not msg.Admin then return "  ⋆  ⇽ هذا الامر يخص :\n الادمن ⇽ المدير ⇽ المنشئ ⇽ المطور فقط \n⋆" end
redis:set(dreem..'welcom:witting'..msg.sender_user_id_,true) 
...
if not msg.Admin then return "  ⋆  ⇽ هذا الامر يخص :\n الادمن ⇽ المدير ⇽ المنشئ ⇽ المطور فقط \n⋆" end
if redis:get(dreem..'welcome:msg'..msg.chat_id_)  then
return Flter_Markdown(redis:get(dreem..'welcome:msg'..msg.chat_id_))
else 
return "⟶ أهلا عزيزي "..msg.TheRankCmd.."  \n⋆  ⇽ نورت المجموعه \n⋆" 
end 
end
...
local groups = redis:smembers(dreem..'group:ids')
...
local pv = redis:smembers(dreem..'users')
local NumPvDel = 0
for i = 1, #pv do
...
redis:setex(dreem..'welcom_ph:witting'..msg.sender_user_id_,300,true) 
...
local Photo_Weloame = redis:get(dreem..':WELCOME_BOT')
if Photo_Weloame then
sendPhoto(msg.chat_id_,msg.id_,Photo_Weloame,[[⚜╿اهلا انآ بوت آسـمـي ]]..redis:get(dreem..':NameBot:')..[[ ✓
...
redis:setex(dreem..'text_sudo:witting'..msg.sender_user_id_,1200,true) 
return '⋆  ⇽ حسنًا  عزيزي \n الان قم بارسال الوصف .\n ⋆' 
end

if MsgText[1] == "ضع شرط التفعيل" and MsgText[2] and MsgText[2]:match('^%d+$') then 
redis:set(dreem..':addnumberusers',MsgText[2]) 
return ' تم وضـع شـرط آلتفعيل آلبوت آذآ گآنت آلمـجمـوعهہ‏‏ آگثر مـن *【'..MsgText[2]..'】* عضـو  .\n' 
end

if MsgText[1] == "شرط التفعيل" then 
return'⋆  ⇽ شـرط آلتفعيل آلبوت آذآ گآنت آلمـجمـوعهہ‏‏ آگثر مـن *【'..redis:get(dreem..':addnumberusers')..'】* عضـو  .' 
end 
end

if MsgText[1] == 'المجموعات' or MsgText[1] == "المجموعات 🌋" then
if not msg.SudoUser then return "هذا الامر يخص المطور, فقط  \n" end
return ' ⋆ ⇽ عدد المجموعات المفعلة  ⋆ `'..redis:scard(dreem..'group:ids')..'`  ⋆' 
end

if MsgText[1] == "المشتركين" or MsgText[1] == "المشتركين Ⓜ" then
if not msg.SudoUser then return "⋆  ⇽ هذا الامر يخص المطور فقط  \n" end
return '⋆ ⇽ عدد المشتركين في البوت ⋆  `'..redis:scard(dreem..'users')..'` ⋆'
end
...
return redis:get(dreem..":TEXT_SUDO") or 'لا يوجد وصف المطور .\nيمكنك اضافه وصف من خلال الامر\n       " `ضع وصف المطور` " '
end
...
redis:setex(dreem..'fwd:'..msg.sender_user_id_,300, true) 
...
redis:setex(dreem..'fwd:all'..msg.sender_user_id_,300, true) 
...
redis:setex(dreem..'fwd:pv'..msg.sender_user_id_,300, true) 
...
redis:setex(dreem..'fwd:groups'..msg.sender_user_id_,300, true) 
...
dreem..'rulse:witting'..msg.sender_user_id_,
dreem..'rulse:witting'..msg.sender_user_id_,
dreem..'name:witting'..msg.sender_user_id_,
dreem..'about:witting'..msg.sender_user_id_,
dreem..'fwd:all'..msg.sender_user_id_,
dreem..'fwd:pv'..msg.sender_user_id_,
dreem..'fwd:groups'..msg.sender_user_id_,
dreem..'namebot:witting'..msg.sender_user_id_,
dreem..'addrd_all:'..msg.sender_user_id_,
dreem..'delrd:'..msg.sender_user_id_,
dreem..'addrd:'..msg.sender_user_id_,
dreem..'delrdall:'..msg.sender_user_id_,
dreem..'text_sudo:witting'..msg.sender_user_id_,
dreem..'addrd:'..msg.chat_id_..msg.sender_user_id_,
dreem..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
...
if not msg.SudoBase then return "⋆  ⇽ هذا الامر يخص المطور الاساسي فقط  \n" end
local GetVerison = https.request('https://github.com/DDIIO/dreem.github.io/GetVersion.txt') or 0
if GetVerison > version then
UpdateSourceStart = true
sendMsg(msg.chat_id_,msg.id_,' يوجد تحديث جديد الان \n جاري تنزيل وتثبيت التحديث .')
redis:set(dreem..":VERSION",GetVerison)
return false
else
...
sendMsg(msg.chat_id_,msg.id_,' عذرًا اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس dreem يرجى جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم\n')
end  
else
...
local inline = {{{text="قناة السورس .",url="t.me/@sourcedreem"}}}
send_key(msg.sender_user_id_,'[ قناة سورس dreem .](t.me/@sourcedreem)',nil,inline,msg.id_)
return false
end

if (MsgText[1]== "الاحصائيات 💥" or MsgText[1]=="الاحصائيات") then
if not msg.SudoBase then return"هذاالامر يخص {المطور الاساسي} فقط  \n" end
return '⋆  ⇽ الاحصائيات : \n\n عدد المجموعات المفعله ⋆ '..redis:scard(dreem..'group:ids')..' ⋆\nعدد المشتركين في البوت ⋆ '..redis:scard(dreem..'users')..' ⋆ \n⋆'
end
---------------[End Function data] -----------------------
if MsgText[1]=="اضف رد عام" or MsgText[1]=="اضف رد عام ➕" then
if not msg.SudoBase then return"هذاالامر يخص {المطور الاساسي} فقط  \n" end
redis:setex(dreem..'addrd_all:'..msg.chat_id_..msg.sender_user_id_,300,true)
redis:del(dreem..'allreplay:'..msg.chat_id_..msg.sender_user_id_)
return "حسنًا  الان ارسل كلمة الرد العام "
end

if MsgText[1]== 'مسح' and MsgText[2]== 'الردود' then
if not msg.Director then return "⋆  ⇽ هذا الامر يخص :\n المدير ⇽ المنشئ ⇽ المطور فقط  \n⋆ " end
local names   = redis:exists(dreem..'replay:'..msg.chat_id_)
local photo   = redis:exists(dreem..'replay_photo:group:'..msg.chat_id_)
local voice   = redis:exists(dreem..'replay_voice:group:'..msg.chat_id_)
local imation   = redis:exists(dreem..'replay_animation:group:'..msg.chat_id_)
local audio   = redis:exists(dreem..'replay_audio:group:'..msg.chat_id_)
local sticker   = redis:exists(dreem..'replay_sticker:group:'..msg.chat_id_)
local video   = redis:exists(dreem..'replay_video:group:'..msg.chat_id_)
if names or photo or voice or imation or audio or sticker or video then
redis:del(dreem..'replay:'..msg.chat_id_,dreem..'replay_photo:group:'..msg.chat_id_,dreem..'replay_voice:group:'..msg.chat_id_,
dreem..'replay_animation:group:'..msg.chat_id_,dreem..'replay_audio:group:'..msg.chat_id_,dreem..'replay_sticker:group:'..msg.chat_id_,dreem..'replay_video:group:'..msg.chat_id_)
...
local names   = redis:exists(dreem..'replay:all')
local photo   = redis:exists(dreem..'replay_photo:group:')
local voice   = redis:exists(dreem..'replay_voice:group:')
local imation   = redis:exists(dreem..'replay_animation:group:')
local audio   = redis:exists(dreem..'replay_audio:group:')
local sticker   = redis:exists(dreem..'replay_sticker:group:')
local video   = redis:exists(dreem..'replay_video:group:')
if names or photo or voice or imation or audio or sticker or video then
redis:del(dreem..'replay:all',dreem..'replay_photo:group:',dreem..'replay_voice:group:',dreem..'replay_animation:group:',dreem..'replay_audio:group:',dreem..'replay_sticker:group:',dreem..'replay_video:group:')
...
if not msg.SudoBase then return"هذا الامر يخص {المطور الاساسي} فقط  \n" end
redis:set(dreem..'delrdall:'..msg.sender_user_id_,true) 
return " حسنًا عزيزي ، \nالان ارسل الرد لمسحها من  المجموعات ."
end

if MsgText[1]== 'مسح' and MsgText[2]== 'رد' then
if not msg.Director then return "⋆  ⇽ هذا الامر يخص :\n المدير ⇽ المنشئ ⇽ المطور فقط  \n⋆ " end
redis:set(dreem..'delrd:'..msg.sender_user_id_,true)
return "حسنًا عزيزي ، \nالان ارسل الرد لمسحها من  للمجموعه ."
end

if MsgText[1]== 'الردود' then
if not msg.Director then return "⋆  ⇽ هذا الامر يخص :\n المدير ⇽ المنشئ ⇽ المطور فقط  \n⋆ " end
local names   = redis:hkeys(dreem..'replay:'..msg.chat_id_)
local photo   = redis:hkeys(dreem..'replay_photo:group:'..msg.chat_id_)
local voice   = redis:hkeys(dreem..'replay_voice:group:'..msg.chat_id_)
local imation   = redis:hkeys(dreem..'replay_animation:group:'..msg.chat_id_)
local audio   = redis:hkeys(dreem..'replay_audio:group:'..msg.chat_id_)
local sticker   = redis:hkeys(dreem..'replay_sticker:group:'..msg.chat_id_)
local video   = redis:hkeys(dreem..'replay_video:group:'..msg.chat_id_)
...
local names   = redis:hkeys(dreem..'replay:all')
local photo   = redis:hkeys(dreem..'replay_photo:group:')
local voice   = redis:hkeys(dreem..'replay_voice:group:')
local imation   = redis:hkeys(dreem..'replay_animation:group:')
local audio   = redis:hkeys(dreem..'replay_audio:group:')
local sticker   = redis:hkeys(dreem..'replay_sticker:group:')
local video   = redis:hkeys(dreem..'replay_video:group:')
if #names==0 and #photo==0 and #voice==0 and #imation==0 and #audio==0 and #sticker==0 and #video==0 then 
...
if not msg.Director then return "⋆  ⇽ هذا الامر يخص :\n المدير ⇽ المنشئ ⇽ المطور فقط  \n⋆ " end
redis:setex(dreem..'addrd:'..msg.chat_id_..msg.sender_user_id_,300,true) 
redis:del(dreem..'replay1'..msg.chat_id_..msg.sender_user_id_)
return "حسنًا , الان ارسل كلمه الرد \n-"
end

if MsgText[1] == "ضع اسم للبوت" or MsgText[1]== 'ضع اسم للبوت ©' then
if not msg.SudoBase then return"هذاالامر يخص {المطور الاساسي} فقط  \n" end
redis:setex(dreem..'namebot:witting'..msg.sender_user_id_,300,true)
...
return [[
  ⋆ مطـور السورس  ⇽  [نِـيدالزهرانَي](http://t.me/Slo09)
⋆ مطـور السورس  ⇽  [عـزام‌الزهرانَي](t.me/eeeel)
⋆ قناة السورس   ⇽  [𝖲𝖮𝖴𝖱𝖢𝖤𝖣𝖱𝖤𝖤𝖬](t.me/SourceDreem)
⋆ ⋆ ⋆ ⋆ ⋆⋆ ⋆ ⋆ ⋆ ⋆⋆ ⋆ ⋆ ⋆ ⋆⋆ ⋆ ⋆ ⋆ ⋆⋆ ⋆ ⋆ ⋆ ⋆
⠀⠀
]]
end
...
return 'عدد تعديلاتك : ⇜ 〈 '..(redis:get(dreem..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)..' 〉 \n🐾'
end
...
if not msg.SudoBase then return"هذاالامر يخص {المطور الاساسي} فقط  \n" end
local SubDel = redis:del(dreem..":UserNameChaneel")
if SubDel == 1 then
...
if not msg.SudoBase then return"هذاالامر يخص {المطور الاساسي} فقط  \n" end
local UserChaneel = redis:get(dreem..":UserNameChaneel")
if UserChaneel then
...
local hash = dreem..'user_names:'..msg.sender_user_id_
redis:set(hash,info)
end
...
------set cmd------
Black = msg.text 
mmd = redis:get(dreem..'addcmd'..msg.chat_id_..msg.sender_user_id_)
if mmd then
redis:sadd(dreem..'CmDlist:'..msg.chat_id_,msg.text)
redis:hset(dreem..'CmD:'..msg.chat_id_,msg.text,mmd)
sendMsg(msg.chat_id_,msg.id_,'اهلًا عزيزي \nتم تثبيت الامر الجديد')
redis:del(dreem..'addcmd'..msg.chat_id_..msg.sender_user_id_)
end
...
redis:setex(dreem..'addcmd'..msg.chat_id_..msg.sender_user_id_,120,cmd)
...
redis:hdel(dreem..'CmD:'..msg.chat_id_,cmd)
redis:srem(dreem..'CmDlist:'..msg.chat_id_,cmd)
sendMsg(msg.chat_id_,msg.id_," ⋆  ⇽ اهلًا عزيزي\nالامر >"..cmd.."\n تم مسحه من قائمه الاوامر . ")
end
if Black == 'مسح قائمه الاوامر' or Black == 'مسح قائمه الاوامر' then
if not msg.Kara then return "هذاالامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n" end
redis:del(dreem..'CmD:'..msg.chat_id_)
redis:del(dreem..'CmDlist:'..msg.chat_id_)
sendMsg(msg.chat_id_,msg.id_,"⋆  ⇽ اهلًا عزيزي تم مسح قائمه الاوامر .")
end
if Black == "قائمه الاوامر" then
if not msg.Kara then return "هذاالامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n" end
local CmDlist = redis:smembers(dreem..'CmDlist:'..msg.chat_id_)
local t = '⋆  ⇽ قائمه الاوامر : \n'
for k,v in pairs(CmDlist) do
mmdi = redis:hget(dreem..'CmD:'..msg.chat_id_,v)
t = t..k..") "..v.." > "..mmdi.."\n" 
end
if #CmDlist == 0 then
...
redis:set(dreem..'welc'..msg.chat_id_,'on')
end
end
if Text == 'welcome off' or Text == 'تعطيل الترحيب' then
if redis:get(dreem..'welc'..msg.chat_id_) == 'off' then
sendMsg(msg.chat_id_,msg.id_,' ⋆ ⇽  تم تعطيل الترحيب سابقا')
redis:set(dreem..'welc'..msg.chat_id_,'off')
redis:del(dreem..'welc'..msg.chat_id_,'on')
else
...
function tophoto(kara,dreem)   
if dreem.content_.ID == "MessageSticker" then        
local bd = dreem.content_.sticker_.sticker_.path_          
...
local msg_pv = tonumber(redis:get(dreem..'user:'..msg.sender_user_id_..':msgs') or 0)
if msg_pv > 5 then
redis:setex(dreem..':mute_pv:'..msg.sender_user_id_,18000,true)   
return sendMsg(msg.chat_id_,0,'*📛│* تم حظرك من البوت بسبب التكرار \n🛠') 
end
redis:setex(dreem..'user:'..msg.sender_user_id_..':msgs',2,msg_pv+1)
end
...
redis:sadd(dreem..'users',msg.sender_user_id_)
if redis:get(dreem..'lock_service') then 
text = [[اهلًا انا بوت اسمي    []]..redis:get(dreem..':NameBot:')..[[] 
...
local MSG_ID = (redis:get(dreem.."USER_MSG_TWASEL"..FwdDate) or 1)
if msg.text then
...
redis:setex(dreem.."USER_MSG_TWASEL"..msg.date_,43200,msg.id_)
...
--====================== Reply Only Group ====================================
if redis:get(dreem..'addrd:'..msg.chat_id_..msg.sender_user_id_) and redis:get(dreem..'replay1'..msg.chat_id_..msg.sender_user_id_) then
local klma = redis:get(dreem..'replay1'..msg.chat_id_..msg.sender_user_id_)
if msg.text then 
redis:hset(dreem..'replay:'..msg.chat_id_,klma,Flter_Markdown(msg.text))
redis:del(dreem..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'(['..klma..'])\n   تم اضافت الرد  \n-')
elseif msg.photo then 
redis:hset(dreem..'replay_photo:group:'..msg.chat_id_,klma,photo_id)
redis:del(dreem..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'⋆  ⇽تم اضافه صوره للرد بنجاح \nيمكنك ارسال ❴ ['..klma..'] ❵ لاضهار الصوره الاتيه . ')
elseif msg.voice then
redis:hset(dreem..'replay_voice:group:'..msg.chat_id_,klma,voice_id)
redis:del(dreem..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'⋆  ⇽ تم اضافه بصمه صوت للرد بنجاح \n يمكنك ارسال ❴ ['..klma..'] ❵ لسماع البصمه الاتيه .')
elseif msg.animation then
redis:hset(dreem..'replay_animation:group:'..msg.chat_id_,klma,animation_id)
redis:del(dreem..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'⋆  ⇽ تم اضافه متحركه للرد بنجاح  \n يمكنك ارسال ❴ ['..klma..'] ❵ لاضهار الصوره الاتيه . ')
elseif msg.video then
redis:hset(dreem..'replay_video:group:'..msg.chat_id_,klma,video_id)
redis:del(dreem..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'⋆  ⇽تم اضافه فيديو للرد بنجاح \nيمكنك ارسال ❴ ['..klma..'] ❵ لاضهار الفيديو الاتي .')
elseif msg.audio then
redis:hset(dreem..'replay_audio:group:'..msg.chat_id_,klma,audio_id)
redis:del(dreem..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'⋆  ⇽ تم اضافه للصوت للرد بنجاح \nيمكنك ارسال ❴ ['..klma..'] ❵ لاضهار الصوت الاتي .')
elseif msg.sticker then
redis:hset(dreem..'replay_sticker:group:'..msg.chat_id_,klma,sticker_id)
redis:del(dreem..'addrd:'..msg.chat_id_..msg.sender_user_id_)
...
--====================== Reply All Groups =====================================
if redis:get(dreem..'addrd_all:'..msg.chat_id_..msg.sender_user_id_) and redis:get(dreem..'allreplay:'..msg.chat_id_..msg.sender_user_id_) then
local klma = redis:get(dreem..'allreplay:'..msg.chat_id_..msg.sender_user_id_)
if msg.text then
redis:hset(dreem..'replay:all',klma,Flter_Markdown(msg.text))
redis:del(dreem..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'(['..klma..'])\n  ⋆  ⇽ تم اضافت الرد لكل المجموعات . ')
elseif msg.photo then 
redis:hset(dreem..'replay_photo:group:',klma,photo_id)
redis:del(dreem..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'⋆  ⇽ تم اضافه صوره للرد العام ✓\nيمكنك ارسال ❴ ['..klma..'] ❵ لاضهار الصوره الاتيه ')
elseif msg.voice then
redis:hset(dreem..'replay_voice:group:',klma,voice_id)
redis:del(dreem..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'⋆  ⇽ تم اضافه بصمه صوت للرد العام ✓\nيمكنك ارسال ❴ ['..klma..'] ❵ لسماع البصمه الاتيه .')
elseif msg.animation then
redis:hset(dreem..'replay_animation:group:',klma,animation_id)
redis:del(dreem..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'⋆  ⇽ تم اضافه متحركه للرد العام \n يمكنك ارسال ❴ ['..klma..'] ❵ لاضهار الصوره الاتيه .')
elseif msg.video then
redis:hset(dreem..'replay_video:group:',klma,video_id)
redis:del(dreem..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'⋆  ⇽ تم اضافه فيديو للرد العام ✓\nيمكنك ارسال ❴ ['..klma..'] ❵لاضهار الفيديو الاتي .')
elseif msg.audio then
redis:hset(dreem..'replay_audio:group:',klma,audio_id)
redis:del(dreem..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'⋆  ⇽ تم اضافه للصوت للرد العام ✓\n يمكنك ارسال ❴ ['..klma..'] ❵ لاضهار الصوت الاتي ')
elseif msg.sticker then
redis:hset(dreem..'replay_sticker:group:',klma,sticker_id)
redis:del(dreem..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
...
if redis:get(dreem..":ForceSub:"..msg.sender_user_id_) then
if msg.text:match("^@[%a%d_]+$") then
redis:del(dreem..":ForceSub:"..msg.sender_user_id_)
...
redis:set(dreem..":UserNameChaneel",msg.text)
...
if redis:get(dreem..'namebot:witting'..msg.sender_user_id_) then --- استقبال اسم البوت 
redis:del(dreem..'namebot:witting'..msg.sender_user_id_)
redis:set(dreem..':NameBot:',msg.text)
Start_Bot() 
sendMsg(msg.chat_id_,msg.id_,"⋆  ⇽ تم تغير اسم البوت  \n، الان اسمه "..Flter_Markdown(msg.text).." \n")
return false
end

if redis:get(dreem..'addrd_all:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال الرد لكل المجموعات
if not redis:get(dreem..'allreplay:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال كلمه الرد لكل المجموعات
redis:hdel(dreem..'replay_photo:group:',msg.text)
redis:hdel(dreem..'replay_voice:group:',msg.text)
redis:hdel(dreem..'replay_animation:group:',msg.text)
redis:hdel(dreem..'replay_audio:group:',msg.text)
redis:hdel(dreem..'replay_sticker:group:',msg.text)
redis:hdel(dreem..'replay_video:group:',msg.text)
redis:setex(dreem..'allreplay:'..msg.chat_id_..msg.sender_user_id_,300,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"⋆  ⇽ جيد , يمكنك الان ارسال جوا ب الردالعام \n[[ نص,صوره,فيديو,متحركه,بصمه,اغنيه ]]")
end
end

if redis:get(dreem..'delrdall:'..msg.sender_user_id_) then
redis:del(dreem..'delrdall:'..msg.sender_user_id_)
local names = redis:hget(dreem..'replay:all',msg.text)
local photo =redis:hget(dreem..'replay_photo:group:',msg.text)
local voice = redis:hget(dreem..'replay_voice:group:',msg.text)
local animation = redis:hget(dreem..'replay_animation:group:',msg.text)
local audio = redis:hget(dreem..'replay_audio:group:',msg.text)
local sticker = redis:hget(dreem..'replay_sticker:group:',msg.text)
local video = redis:hget(dreem..'replay_video:group:',msg.text)
if not (names or photo or voice or animation or audio or sticker or video) then
return sendMsg(msg.chat_id_,msg.id_,'⋆  ⇽هذا الرد ليس مضاف في قائمه الردود .')
else
redis:hdel(dreem..'replay:all',msg.text)
redis:hdel(dreem..'replay_photo:group:',msg.text)
redis:hdel(dreem..'replay_voice:group:',msg.text)
redis:hdel(dreem..'replay_audio:group:',msg.text)
redis:hdel(dreem..'replay_animation:group:',msg.text)
...
if redis:get(dreem..'text_sudo:witting'..msg.sender_user_id_) then -- استقبال كليشه المطور
redis:del(dreem..'text_sudo:witting'..msg.sender_user_id_) 
redis:set(dreem..':TEXT_SUDO',Flter_Markdown(msg.text))
...
redis:set(dreem..'rulse:msg'..msg.chat_id_,Flter_Markdown(msg.text)) 
return sendMsg(msg.chat_id_,msg.id_,'⋆  ⇽ مرحبآ عزيزي\nتم حفظ القوانين بنجاح ✓\nارسل [[ القوانين ]] لعرضها \n ✓')
end
if redis:get(dreem..'name:witting'..msg.sender_user_id_) then --- استقبال الاسم
redis:del(dreem..'name:witting'..msg.sender_user_id_) 
tdcli_function({ID= "ChangeChatTitle",chat_id_=msg.chat_id_,title_=msg.text},dl_cb,nil)
end
if redis:get(dreem..'linkGroup'..msg.sender_user_id_,link) then --- استقبال الرابط
redis:del(dreem..'linkGroup'..msg.sender_user_id_,link) 
redis:set(dreem..'linkGroup'..msg.chat_id_,Flter_Markdown(msg.text)) 
return sendMsg(msg.chat_id_,msg.id_,'تم وضع الرابط الجديد بنجاح .. ')
end
if redis:get(dreem..'about:witting'..msg.sender_user_id_) then --- استقبال الوصف
redis:del(dreem..'about:witting'..msg.sender_user_id_) 
...
if redis:get(dreem..'fwd:all'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه عام
redis:del(dreem..'fwd:all'..msg.sender_user_id_)
local pv = redis:smembers(dreem..'users')  
local groups = redis:smembers(dreem..'group:ids')
...
if redis:get(dreem..'fwd:pv'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه خاص
redis:del(dreem..'fwd:pv'..msg.sender_user_id_)
local pv = redis:smembers(dreem..'users')
if #pv >= 300 then
...
if redis:get(dreem..'fwd:groups'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه خاص
redis:del(dreem..'fwd:groups'..msg.sender_user_id_)
local groups = redis:smembers(dreem..'group:ids')
if #groups >= 300 then
...
if msg.adduser and msg.adduser == our_id and redis:get(dreem..':WELCOME_BOT') then
sendPhoto(msg.chat_id_,msg.id_,redis:get(dreem..':WELCOME_BOT'),[[⚜╿اهلا انآ بوت آسـمـي ]]..redis:get(dreem..':NameBot:')..[[ ✓
👨🏻‍✈️│آختصـآصـي حمـآيهہ‌‏ آلمـجمـوعآت
📛╽مـن آلسـبآم وآلتوجيهہ‌‏ وآلتگرآر وآلخ...
...
if msg.forward_info and redis:get(dreem..'fwd:'..msg.sender_user_id_) then
redis:del(dreem..'fwd:'..msg.sender_user_id_)
local pv = redis:smembers(dreem..'users')
local groups = redis:smembers(dreem..'group:ids')
local allgp =  #pv + #groups
if allgp == 500 then
...
if msg.content_.ID == "MessagePhoto" and redis:get(dreem..'welcom_ph:witting'..msg.sender_user_id_) then
redis:del(dreem..'welcom_ph:witting'..msg.sender_user_id_)
if msg.content_.photo_.sizes_[3] then 
photo_id = msg.content_.photo_.sizes_[3].photo_.persistent_id_
else 
photo_id = msg.content_.photo_.sizes_[0].photo_.persistent_id_
end
redis:set(dreem..':WELCOME_BOT',photo_id)
return sendMsg(msg.chat_id_,msg.id_,'⋆  ⇽ تم تغيير صـوره الترحيب للبوت .')
end 

if msg.content_.ID == "MessagePhoto" and msg.type == "channel" and msg.GroupActive then
if redis:get(dreem..'photo:group'..msg.chat_id_..msg.sender_user_id_) then
redis:del(dreem..'photo:group'..msg.chat_id_..msg.sender_user_id_)
if msg.content_.photo_.sizes_[3] then 
photo_id = msg.content_.photo_.sizes_[3].photo_.persistent_id_
else 
photo_id = msg.content_.photo_.sizes_[0].photo_.persistent_id_
...
if redis:get(dreem..'addrd:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال الرد للمجموعه فقط

if not redis:get(dreem..'replay1'..msg.chat_id_..msg.sender_user_id_) then  -- كلمه الرد
redis:hdel(dreem..'replay:'..msg.chat_id_,msg.text)
redis:hdel(dreem..'replay_photo:group:'..msg.chat_id_,msg.text)
redis:hdel(dreem..'replay_voice:group:'..msg.chat_id_,msg.text)
redis:hdel(dreem..'replay_animation:group:'..msg.chat_id_,msg.text)
redis:hdel(dreem..'replay_audio:group:'..msg.chat_id_,msg.text)
redis:hdel(dreem..'replay_sticker:group:'..msg.chat_id_,msg.text)
redis:hdel(dreem..'replay_video:group:'..msg.chat_id_,msg.text)
redis:setex(dreem..'replay1'..msg.chat_id_..msg.sender_user_id_,300,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"⋆  ⇽ جيد , يمكنك الان ارسال جواب الرد \n [[ نص,صوره,فيديو,متحركه,بصمه,اغنيه ]]\n✓")
end
end

if redis:get(dreem..'delrd:'..msg.sender_user_id_) then
redis:del(dreem..'delrd:'..msg.sender_user_id_)
local names   = redis:hget(dreem..'replay:'..msg.chat_id_,msg.text)
local photo   = redis:hget(dreem..'replay_photo:group:'..msg.chat_id_,msg.text)
local voice   = redis:hget(dreem..'replay_voice:group:'..msg.chat_id_,msg.text)
local animation = redis:hget(dreem..'replay_animation:group:'..msg.chat_id_,msg.text)
local audio   = redis:hget(dreem..'replay_audio:group:'..msg.chat_id_,msg.text)
local sticker   = redis:hget(dreem..'replay_sticker:group:'..msg.chat_id_,msg.text)
local video   = redis:hget(dreem..'replay_video:group:'..msg.chat_id_,msg.text)
if not (names or photo or voice or animation or audio or sticker or video) then
return sendMsg(msg.chat_id_,msg.id_,'⋆  ⇽ هذا الرد ليس مضاف في قائمه الردود .')
else
redis:hdel(dreem..'replay:'..msg.chat_id_,msg.text)
...
if msg.pinned then
print(" -- pinned -- ")
local msg_pin_id = redis:get(dreem..":MsgIDPin:"..msg.chat_id_)
if not msg.Director and redis:get(dreem..'lock_pin'..msg.chat_id_) then
if msg_pin_id then
...
redis:set(dreem..":MsgIDPin:"..msg.chat_id_,msg.id_)
end
...
GetUserID(msg.sender_user_id_,function(arg,data)
redis:set(dreem..'group:name'..msg.chat_id_,msg.content_.title_)
if data.username_ then UserName = "@"..data.username_ else UserName = "احد المشرفين" end
...
GetUserID(msg.sender_user_id_,function(arg,data)  
welcome = (redis:get(dreem..'welcome:msg'..msg.chat_id_) or "🙋🏻‍♂│اهلن بك عزيزي {الاسم}\n🎟│معرفك » {المعرف}\n{القوانين}\n\nالرجاء الالتزام بالقوانين ♥\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n⚜│اسم الكروب » {المجموعه}")
if welcome then
rules = (redis:get(dreem..'rulse:msg'..msg.chat_id_) or "👨🏻‍💻╿مرحبأ عزيري القوانين كلاتي 👇🏻\n♦️│ممنوع نشر الروابط\n⚠️│ممنوع التكلم او نشر صور اباحيه\n⚔│ممنوع  اعاده توجيه\n💭│ممنوع التكلم بلطائفه\n♥️╽الرجاء احترام المدراء والادمنيه 😅\n")
welcome = welcome:gsub("{القوانين}", rules)
if data.username_ then UserName = '@'..data.username_ else UserName = '< لا يوجد معرف >' end
welcome = welcome:gsub("{المجموعه}",Flter_Markdown((redis:get(dreem..'group:name'..msg.chat_id_) or '')))
...
--------------------------------------------
if msg.adduser and redis:get(dreem..'welcome:get'..msg.chat_id_) then
local adduserx = tonumber(redis:get(dreem..'user:'..msg.sender_user_id_..':msgs') or 0)
if adduserx > 3 then 
redis:del(dreem..'welcome:get'..msg.chat_id_)
end
redis:setex(dreem..'user:'..msg.sender_user_id_..':msgs',3,adduserx+1)
end

if not msg.Admin and not msg.Special and not (msg.adduser or msg.joinuser or msg.deluser ) then -- للاعضاء فقط   

if not msg.forward_info and redis:get(dreem..'lock_flood'..msg.chat_id_)  then
local msgs = (redis:get(dreem..'user:'..msg.sender_user_id_..':msgs') or 0)
local NUM_MSG_dreem = (redis:get(dreem..'num_msg_dreem'..msg.chat_id_) or 5)
if tonumber(msgs) > tonumber(NUM_MSG_dreem) then 
GetUserID(msg.sender_user_id_,function(arg,datau)
Restrict(msg.chat_id_,msg.sender_user_id_,1)
redis:setex(dreem..'sender:'..msg.sender_user_id_..':flood',30,true)
if datau.username_ then USERNAME = '@'..datau.username_ else USERNAME = FlterName(datau.first_name_..' '..(datau.last_name_ or "")) end
local USERCAR = utf8.len(USERNAME)
SendMention(msg.chat_id_,datau.id_,msg.id_," - العضو » "..USERNAME.."\n    - قمـت بتگرآر آگثر مـن "..NUM_MSG_dreem.." رسـآلهہ‌‏ , لذآ تم تقييدگ مـن آلمـجمـوعهہ‌‏ ✓\n",12,USERCAR) 
return false
end)
end 
redis:setex(dreem..'user:'..msg.sender_user_id_..':msgs',2,msgs+1)
end
...
if redis:get(dreem..'mute_forward'..msg.chat_id_) then -- قفل التوجيه
...
if redis:get(dreem..'lock_woring'..msg.chat_id_) and not redis:get(dreem..':User_Fwd_Msg:'..msg.sender_user_id_..':flood') then
GetUserID(msg.sender_user_id_,function(arg,data)
...
return redis:setex(dreem..':User_Fwd_Msg:'..msg.sender_user_id_..':flood',15,true)
end,nil)
end
end)
return false
elseif redis:get(dreem..':tqeed_fwd:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif tonumber(msg.via_bot_user_id_) ~= 0 and redis:get(dreem..'mute_inline'..msg.chat_id_) then -- قفل الانلاين
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
if utf8.len(msg.text) > 500 and redis:get(dreem..'lock_spam'..msg.chat_id_) then -- قفل الكليشه 
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(dreem..':tqeed_link:'..msg.chat_id_)  then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(dreem..'lock_link'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif (msg.text:match("[Hh][Tt][Tt][Pp][Ss]://") or msg.text:match("[Hh][Tt][Tt][Pp]://") or msg.text:match("[Ww][Ww][Ww].") or msg.text:match(".[Cc][Oo][Mm]") or msg.text:match(".[Tt][Kk]") or msg.text:match(".[Mm][Ll]") or msg.text:match(".[Oo][Rr][Gg]")) and redis:get(dreem..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.text:match("#[%a%d_]+") and redis:get(dreem..'lock_tag'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.text:match("@[%a%d_]+")  and redis:get(dreem..'lock_username'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif not msg.textEntityTypeBold and (msg.textEntityTypeBold or msg.textEntityTypeItalic) and redis:get(dreem..'lock_markdown'..msg.chat_id_) then 
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.textEntityTypeTextUrl and redis:get(dreem..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.edited and redis:get(dreem..'lock_edit'..msg.chat_id_) then -- قفل التعديل
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.content_.ID == "MessageUnsupported" and redis:get(dreem..'mute_video'..msg.chat_id_) then -- قفل الفيديو
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.photo then
if redis:get(dreem..'mute_photo'..msg.chat_id_)  then -- قفل الصور
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(dreem..':tqeed_photo:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.video then
if redis:get(dreem..'mute_video'..msg.chat_id_) then -- قفل الفيديو
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(dreem..':tqeed_video:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.document and redis:get(dreem..'mute_document'..msg.chat_id_) then -- قفل الملفات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.sticker and redis:get(dreem..'mute_sticker'..msg.chat_id_) then --قفل الملصقات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.animation then
if redis:get(dreem..'mute_gif'..msg.chat_id_) then -- قفل المتحركه
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(dreem..':tqeed_gif:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.contact and redis:get(dreem..'mute_contact'..msg.chat_id_) then -- قفل الجهات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.location and redis:get(dreem..'mute_location'..msg.chat_id_) then -- قفل الموقع
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.voice and redis:get(dreem..'mute_voice'..msg.chat_id_) then -- قفل البصمات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.game and redis:get(dreem..'mute_game'..msg.chat_id_) then -- قفل الالعاب
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.audio and redis:get(dreem..'mute_audio'..msg.chat_id_) then -- قفل الصوت
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.replyMarkupInlineKeyboard and redis:get(dreem..'mute_keyboard'..msg.chat_id_) then -- كيبورد
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(dreem..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.content_.caption_:match("@[%a%d_]+") and redis:get(dreem..'lock_username'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
if msg.text and redis:get(dreem..'replay'..msg.chat_id_) then

local Replay = false

 Replay = redis:hget(dreem..'replay:all',msg.text)
if Replay then
sendMsg(msg.chat_id_,msg.id_,Replay)
return false
end

 Replay = redis:hget(dreem..'replay:'..msg.chat_id_,msg.text)
if Replay then 
 sendMsg(msg.chat_id_,msg.id_,Replay) 
return false
end
 Replay = redis:hget(dreem..'replay_photo:group:',msg.text)
if Replay then 
 sendPhoto(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(dreem..'replay_voice:group:',msg.text)
if Replay then 
 sendVoice(msg.chat_id_,msg.id_,Replay)
return false
end

Replay = redis:hget(dreem..'replay_animation:group:',msg.text)
if Replay then 
 sendAnimation(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(dreem..'replay_audio:group:',msg.text)
if Replay then 
 sendAudio(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(dreem..'replay_sticker:group:',msg.text)
if Replay then 
 sendSticker(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(dreem..'replay_video:group:',msg.text)
if Replay then 
print("0000000000000") 
...
Replay = redis:hget(dreem..'replay_photo:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendPhoto(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(dreem..'replay_voice:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendVoice(msg.chat_id_,msg.id_,Replay)
return false
end

Replay = redis:hget(dreem..'replay_animation:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendAnimation(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(dreem..'replay_audio:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendAudio(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(dreem..'replay_sticker:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendSticker(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(dreem..'replay_video:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendVideo(msg.chat_id_,msg.id_,Replay)
return false
end
...
json_data = '{"BotID": '..dreem..',"UserBot": "'..Bot_User..'","Groups" : {'
local All_Groups_ID = redis:smembers(dreem..'group:ids')
for key,GroupS in pairs(All_Groups_ID) do
local NameGroup = (redis:get(dreem..'group:name'..GroupS) or '')
...
local admins = redis:smembers(dreem..'admins:'..GroupS)
if #admins ~= 0 then
json_data =  json_data..',"Admins" : {'
for key,value in pairs(admins) do
local info = redis:hgetall(dreem..'username:'..value)
if info then 
...
local creators = redis:smembers(dreem..':MONSHA_BOT:'..GroupS)
if #creators ~= 0 then
...
local creator = redis:smembers(dreem..':KARA_BOT:'..GroupS)
if #creator ~= 0 then
...
local owner = redis:smembers(dreem..'owners:'..GroupS)
if #owner ~= 0 then
...
if redis:get(dreem..'CheckExpire::'..msg.chat_id_) then
local ExpireDate = redis:ttl(dreem..'ExpireDate:'..msg.chat_id_)
if not ExpireDate and not msg.SudoUser then
rem_data_group(msg.chat_id_)
sendMsg(SUDO_ID,0,'🕵🏼️‍♀️╿انتهى الاشتراك في احد المجموعات ✋🏿\n👨🏾‍🔧│المجموعه : '..FlterName(redis:get(dreem..'group:name'..msg.chat_id_))..'🍃\n💂🏻‍♀️╽ايدي : '..msg.chat_id_)
sendMsg(msg.chat_id_,0,'🕵🏼️‍♀️╿انتهى الاشتراك البوت✋🏿\n💂🏻‍♀️│سوف اغادر المجموعه فرصه سعيده 👋🏿\n👨🏾‍🔧╽او راسل المطور للتجديد '..SUDO_USER..' 🍃')
return StatusLeft(msg.chat_id_,our_id)
else
local DaysEx = (redis:ttl(dreem..'ExpireDate:'..msg.chat_id_) / 86400)
